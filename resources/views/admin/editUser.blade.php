	                            ...
	                            <div class="row">
	                                <div class="col-md-8">
	                                    <div class="form-group">
	                                        ...
	                                        <input type="text" id="normal-input" name="name" class="form-control" placeholder="Name" value="{{ $user->name }}">
	                                    </div>
	                                </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="normal-input" name="email" class="form-control" placeholder="Email" value="{{ $user->email }}">
                                        </div>
                                    </div>
